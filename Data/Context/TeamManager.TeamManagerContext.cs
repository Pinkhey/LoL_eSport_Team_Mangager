...
namespace cnTeamManager
{
    ...
    public partial class TeamManagerContext : DbContext
    {
        ...
        private void UsersMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Users>().Property(x => x.UserId).HasColumnName(@"UserId").IsRequired().ValueGeneratedNever();
        ...
        private void TeamsMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Teams>().Property(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<Teams>().Property(x => x.Name).HasColumnName(@"Name").IsRequired().ValueGeneratedNever().HasMaxLength(100);
            modelBuilder.Entity<Teams>().Property(x => x.Region).HasColumnName(@"Region").IsRequired().ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<Teams>().Property(x => x.League).HasColumnName(@"League").IsRequired().ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<Teams>().Property(x => x.CoachId).HasColumnName(@"CoachId").IsRequired().ValueGeneratedNever();
        ...
        private void PlayersMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Players>().Property(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedNever();
        ...
        private void MatchesMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Matches>().Property(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedNever();
            ...
            modelBuilder.Entity<Matches>().Property(x => x.Result).HasColumnName(@"Result").IsRequired().ValueGeneratedNever().HasMaxLength(10);
        ...
        private void PlayerStatsMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PlayerStats>().Property(x => x.Id).HasColumnName(@"Id").IsRequired().ValueGeneratedNever();
            ...
            modelBuilder.Entity<PlayerStats>().Property(x => x.KDA).HasColumnName(@"KDA").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<PlayerStats>().Property(x => x.Score).HasColumnName(@"Score").IsRequired().ValueGeneratedNever();
            modelBuilder.Entity<PlayerStats>().Property(x => x.Form).HasColumnName(@"Form").IsRequired().ValueGeneratedNever();
